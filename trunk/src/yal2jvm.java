...
// melhorar identificacao de array
  ...
  static final public void Term() throws ParseException {
    ...
    case ID:
      ...
      try {
                jjtree.closeNodeScope(jjtn003, true);
                jjtc003 = false;
               jjtn003.val=t0.image; jjtn003.beginLine = t0.beginLine;
      } finally {
                if (jjtc003) {
                  jjtree.closeNodeScope(jjtn003, true);
                }
      ...
      if (jj_2_2(2)) {
        ...
        case 33:
          ...
          try {
                         jjtree.closeNodeScope(jjtn004, true);
                         jjtc004 = false;
                        jjtn004.val=t1.image; jjtn004.beginLine = t1.beginLine;
          } finally {
                         if (jjtc004) {
                           jjtree.closeNodeScope(jjtn004, true);
                         }
  ...
  static final public void Call() throws ParseException {
    ...
    try {
                jjtree.closeNodeScope(jjtn001, true);
                jjtc001 = false;
               jjtn001.val = t0.image; jjtn001.beginLine = t0.beginLine;
    } finally {
                if (jjtc001) {
                  jjtree.closeNodeScope(jjtn001, true);
                }
